...
type CartContextType = {
  ...
  countAllItems: () => number;  // New function to count total items
};
...
export const CartContextProvider = ({
  ...
  // New function to calculate total quantity of items in the cart
  const countAllItems = () => {
  ...
  return (
    <CartContext.Provider
      value={{
        ...
        fetchCart,
        countAllItems,  // Expose the new function
      }}
    >
      {children}
    </CartContext.Provider>
