    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (response.ok) {
          ...
          router.push(
            `/error?errorMessage=${encodeURIComponent(errorData.error)}`
          );
        }
      } catch (error) {
  ...
  return (
    <div className="w-full">
      ...
      >
        ...
        <div className="w-full space-y-4 px-4 lg:w-1/3">
          {/* Status */}
          <div className="max-w-4xl rounded bg-white p-4 shadow lg:shadow-lg">
          ...
          {/* Categories */}
          <div className="max-w-md rounded bg-white p-4 shadow lg:shadow-lg">
          ...
          <div className="max-w-md rounded bg-white p-4 shadow lg:shadow-lg">
            <div className="w-full">
              <label htmlFor="newCategory" className="mb-2 block font-medium">
                Or Add New Category
              </label>
              <input
                id="newCategory"
