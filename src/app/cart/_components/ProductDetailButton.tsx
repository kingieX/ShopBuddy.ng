...
const ProductDetailButton: React.FC<AddToCartButtonProps> = ({ productId }) => {
  ...
  return (
    <button
      className="w-full rounded-b-md bg-black py-2 text-white transition-opacity hover:bg-black/80 lg:group-hover:opacity-100"
